...
<aside class="kuali-security__ledger" aria-label="Built-in security guarantees">

<p class="kuali-security__ledger-title">By default, always</p>

<ul class="kuali-security__list">

<li class="kuali-security__row">
...
<div class="kuali-security__row-body" markdown>
<p class="kuali-security__row-head">You see only what your Kuali user sees</p>
<p class="kuali-security__row-text">Every call runs as the key's owner. If it's hidden from you in the web UI, it's hidden from the Connector and your assistant too.</p>
</div>
</li>
...
<div class="kuali-security__row-body" markdown>
<p class="kuali-security__row-head">Your API key stays on your machine</p>
<p class="kuali-security__row-text">Stored in your OS keychain — macOS Keychain, Windows Credential Manager, or libsecret on Linux. Your AI vendor never sees it.</p>
</div>
</li>
...
<div class="kuali-security__row-body" markdown>
<p class="kuali-security__row-head">Read-only mode hides every write tool</p>
<p class="kuali-security__row-text"><code>kuali mcp setup --tools read-only</code> strips create / update / submit / approve / delete / import from the tool list — not flagged, hidden.</p>
</div>
</li>
...
<div class="kuali-security__row-body" markdown>
<p class="kuali-security__row-head">Everything lands in your audit log</p>
<p class="kuali-security__row-text">Same APIs as the web UI, same audit trail — tagged to the user whose API key was used.</p>
</div>
</li>
...
<div class="kuali-security__row-body" markdown>
<p class="kuali-security__row-head">TLS enforced and rate-limited</p>
<p class="kuali-security__row-text">Traffic is TLS-encrypted end-to-end. Requests are rate-limited (10/sec sustained, burst of 20) so an overeager prompt can't hammer your instance.</p>
</div>
</li>
